...
| `editor-pick.py` | **«Выбор редактора»** — сверху карточки редактора (Simon Kirsanov) + канала-редактора @sartirmsk (крупные, небрежно повёрнуты, картинка целиком), ниже 3 карточки событий с его рецензиями (из t.me/s/sartirmsk). Аватар редактора — `editor-simon.jpg`. | Раз в неделю, кураторская колонка |
