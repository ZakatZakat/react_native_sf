...
PICKS=[
 ("Dead Time","Тим Парщиков «Dead Time»","art"),
 ("Туманная облачность","«Туманная облачность»","art"),
 ("Школа иллюстраторов","«Школа иллюстраторов»","art"),
 ("Токсики","Шоу «Токсики»","stage"),
 ("Богатые тоже плачут","«Богатые тоже плачут»","talk"),
 ("Смена фокуса","«Смена фокуса» — Ruarts","art"),
 ("Копенгаген","«Копенгаген» — Театр Труда","stage"),
 ("Врубель. Рождение","Врубель — музей ДПИ","art"),
 ("Beat Weekend","Beat Weekend","cinema"),
 ("SIGMA Festival","Сигма-фест — Dex","party"),
 ("Трава по пояс","«Трава по пояс»","art"),
 ("0.07","«0.07 [Агентность]»","art"),
 ("Мягкое кресло","Кинопоказ «Мягкое кресло»","cinema"),
 ("Вселенная в фарфоре","«Вселенная в фарфоре»","art"),
]
def find_event(sub):
    k=low(sub)
    best=None
...
<div class="wrap"><div class="inner">
  <div class="top">
    ...
    <div class="hd-meta"><span class="dstamp">15–18 сентября</span><span class="pick">★ выбор недели</span></div>
  </div>
  <div class="h1">Выбор <span class="hl">недели</span></div>
  <div class="rule"></div>
  <div class="list">{''.join(rows)}</div>
  <div class="foot">полная афиша москвы — в приложении · #артнеделя</div>
</div></div>"""
out=pathlib.Path(__file__).parent/"weeklist.html"
