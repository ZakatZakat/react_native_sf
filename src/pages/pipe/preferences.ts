...
export const INTERESTS: Interest[] = [
  {
    ...
    symbol: "◤",
    keywords: ["совр", "contemporary", "garage", "v-a-c", "гэс-2", "пермм", "арт-объект", "инсталляц"],
  },
  {
    key: "cinema",
    label: "Кино",
    symbol: "▶",
    keywords: ["кино", "фильм", "показ", "screening", "режис", "cinema", "киновед", "док"],
  },
  {
    key: "theatre",
    label: "Театр",
    symbol: "◐",
    keywords: ["театр", "спектакл", "пьес", "постановк", "сцен"],
  },
  {
    key: "performance",
    label: "Перформанс",
    symbol: "◆",
    keywords: ["перформ", "performance", "акци", "хеппенинг", "процесс"],
  },
  {
    key: "exhibition",
    label: "Выставки",
    symbol: "▢",
    keywords: ["выстав", "галере", "экспоз", "биенналь", "вернисаж"],
  },
  {
    key: "literature",
    label: "Литература",
    symbol: "▤",
    keywords: ["литер", "книг", "поэз", "стих", "проза", "чтени", "автор"],
  },
  {
    key: "music",
    label: "Музыка",
    symbol: "♪",
    keywords: ["концерт", "музык", "live", "gig", "оркест", "хор", "опер", "симфон"],
  },
  {
    key: "dance",
    label: "Танец",
    symbol: "※",
    keywords: ["танец", "танц", "балет", "хореогр", "contemporary dance"],
  },
  {
    key: "photo",
    label: "Фотография",
    symbol: "◳",
    keywords: ["фото", "photo", "снимк", "репортаж"],
  },
  {
    key: "architecture",
    label: "Архитектура",
    symbol: "▲",
    keywords: ["архитект", "урбан", "город", "здани", "пространств"],
  },
  {
    key: "design",
    label: "Дизайн",
    symbol: "◎",
    keywords: ["дизайн", "график", "плакат", "иллюстр", "design", "тип"],
  },
  {
    key: "talks",
    label: "Лекции",
    symbol: "¶",
    keywords: ["лекц", "talk", "дискус", "круглый стол", "встреч с"],
  },
]
