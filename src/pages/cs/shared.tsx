...
const KEYFRAMES = `
  ...
  .cs-deck-blurb { font-family: var(--cs-font-sans); font-size: 9px; line-height: 1.38; color: rgba(13,13,13,0.66); margin-top: 6px; display: -webkit-box; -webkit-line-clamp: 10; -webkit-box-orient: vertical; overflow: hidden; }
