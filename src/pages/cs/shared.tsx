...
const KEYFRAMES = `
  ...
  /* Фото места — на всю ширину, в НАТУРАЛЬНОМ соотношении (height:auto): карточка
     ровняется под картинку, без серых полей-леттербокса. Как постер ивента
     (.cs-pola-img). Очень высокие фото подрезаются cover'ом по max-height. */
  .cs-deck-place-img { width: 100%; overflow: hidden; border-bottom: 2px solid #0D0D0D; background: #E4E4E1; }
  .cs-deck-place-img img { width: 100%; height: auto; max-height: 190px; object-fit: cover; display: block; }
