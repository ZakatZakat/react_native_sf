 ...
 *  По просьбе: интро (лендинг → «Неделя») показывается ВСЕГДА, не раз в неделю —
 *  поэтому всегда возвращаем false, и вход с «/» каждый раз играет интро с лендинга.
 *  (storageKey/weekKey ещё используются markIntroSeen — механику не удаляем, чтобы
 *  легко вернуть «раз в неделю»: восстановить тело этой функции.) */
