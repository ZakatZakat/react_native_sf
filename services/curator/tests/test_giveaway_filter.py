...
REAL = [
    ...
    # рекап-видео (однострочник) со словом «разыгрываем» глубоко в теле — НЕ розыгрыш
    "Смотрим новое видео с выступления FUMI на главной сцене Monasterio Fest, а ещё разыгрываем билеты",
]
