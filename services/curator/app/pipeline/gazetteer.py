...
VENUES: tuple[Venue, ...] = (
    ...
    Venue("rgb_cvl", 55.7513, 37.6125, ("@oriental_centre",),
    ...
    Venue("nevrotik", 55.74951, 37.64511, (), ("клуб «Невротик»",)),
    ...
    Venue("ugol", 55.77354, 37.66980, (), ("КЦ «Угол»",)),
    ...
    Venue("galereya_hodynka", 55.78849, 37.49217, (), ("Галерея «Ходынка»",)),
    ...
    Venue("centr_voznesenskogo", 55.73555, 37.62403, (), ("Центр Вознесенского",)),
    ...
    Venue("orbita", 55.75052, 37.64350, (), ("бар орбита",)),
    ...
    # Многие названия стоят в GENERIC_ALIAS_STOPLIST («невротик», «стрелка»,
    # «кристалл», «ходынка», «угол», «орбита», «dff», «dex») → у них матч только
    # по handle канала, алиасы — лишь различимые многословные формы.
    Venue("neurotic", 55.74950, 37.64510, ("@neuroticlub",)),
    Venue("dff", 55.74642, 37.64702, ("@dffradio",)),
    Venue("cube_moscow", 55.75740, 37.61330, ("@cube_moscow",), ("cube.moscow", "cube moscow")),
    Venue("mamm", 55.74166, 37.59854, ("@multimediaartmuseum",),
          ("мамм", "mamm", "мультимедиа арт музей")),
    ...
    Venue("orbita", 55.75049, 37.64333, ("@orbita_yauza",), ("орбита на яузе",)),
    ...
    Venue("khodynka", 55.78851, 37.49215, ("@khodynkagallery",), ("галерея ходынка",)),
    Venue("ceam", 55.75630, 37.60360, ("@ceammc",),
          ("цэам", "ceam", "центр электроакустической музыки")),
    Venue("voznesensky", 55.73554, 37.62403, ("@voznesenskycenter",),
          ("центр вознесенского", "voznesensky center")),
    Venue("vladey", 55.75605, 37.66584, ("@vladeygram",),
          ("vladey", "владей", "галерея ovcharenko")),
    ...
    Venue("ugol", 55.77330, 37.66941, ("@ugolmsk",)),
    ...
    Venue("strelka_bar", 55.74258, 37.60937, ("@strelkabarmoscow",),
          ("strelka bar", "бар стрелка")),
    ...
    Venue("peresvetov", 55.71467, 37.66175, ("@peresvetovgallery",),
          ("пересветов переулок", "галерея пересветов")),
    Venue("bomba", 55.77924, 37.69008, ("@galereyabomba",), ("галерея бомба",)),
    Venue("naive_museum", 55.76903, 37.63447, ("@musnaive",),
          ("музей русского лубка", "музей наивного искусства")),
    ...
    Venue("rosizo", 55.75667, 37.63656, ("@ros_iso",),
          ("росизо", "rosizo", "выставочные залы росизо")),
