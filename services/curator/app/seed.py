...
INITIAL_TAGS: list[dict] = [
    ...
    },
    {
        ...
        # NB: «режисс» убрано — «режиссёр фильма» ловил каждый кинопоказ в «театр»
        # (у кино есть свой «режис»). Театр надёжно берётся по спектакль/театр/
        # постановка/пьеса/сцена. См. backfill_retag_theatre.
        "keywords": ["театр", "спектакл", "пьес", "постановк", "сцена ", "сцены "],
    },
    {
